...
test('Abbreviations: Geographic', function (t) {
    ...
    (
        ...
        t.test('should NOT treat `' + state + '.` as a terminal marker',
            function (st) {
                describeFixture(
                    st,
    ...
    (
        ...
        t.test('should NOT treat `' + county + '.` as a terminal marker',
            function (st) {
                describeFixture(
                    st,
...
test('Abbreviations: Title abbreviations', function (t) {
    (
        ...
        t.test('should NOT treat `' + title + '.` as a terminal marker',
            function (st) {
                describeFixture(
                    st,
...
test('Abbreviations: English unit abbreviations', function (t) {
    (
        ...
        t.test('should NOT treat `' + unit + '.` as a terminal marker',
            function (st) {
                describeFixture(
                    st,
                    'unit-' + unit,
...
test('Abbreviations: Time references', function (t) {
    'sec|min|hr'.split('|').forEach(function (time) {
        t.test('should NOT treat `' + time + '.` as a terminal marker',
            function (st) {
                describeFixture(
                    st,
                    'time-' + time,
    ...
    (
        ...
        t.test('should NOT treat `' + day + '.` as a terminal marker',
            function (st) {
                describeFixture(
                    st,
                    'day-' + day.toLowerCase(),
    ...
    (
        ...
        t.test('should NOT treat `' + month + '.` as a terminal marker',
            function (st) {
                describeFixture(
                    st,
